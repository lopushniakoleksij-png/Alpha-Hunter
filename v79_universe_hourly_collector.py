...
def retention_cleanup_enabled(validation_mode: str | None) -> bool:
    """Keep validation/evidence runs append-only; scheduled retention stays explicit."""
    return str(validation_mode or "").strip().lower() != "evidence_only"
...
def main() -> int:
    ...
    if retention_cleanup_enabled(
        ...
        retention_status = "EXECUTED"
    else:
        purged = 0
        retention_status = "SKIPPED_EVIDENCE_ONLY"
