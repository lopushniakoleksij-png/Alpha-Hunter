...
create or replace view public.alpha_hunter_nonstop_production_status_v02
...
select
  ...
  'nonstop-production-status-v0.2'::text as model_version
from assembled a;


revoke all on public.alpha_hunter_nonstop_production_status_v02
  from public,anon,authenticated,service_role;

grant select on public.alpha_hunter_nonstop_production_status_v02
  to service_role;
